...
$translation = array(
	...
	"nav_home" => "Accueil",
	"accessThisDocument" => "Accéder au document",
	"listing_nothing" => "Rien à afficher ici",
	"listing_comeBack" => "Mais revenez plus tard, cette page sera remplie d'articles vraiment intéressants!",
	...
	"admin_caption" => "Légende de l'image",
	...
	"admin_itemURL" => "Lien vers l'objet",
	"admin_itemUrlTitle" => "Texte du lien",
	"admin_itemImage" => "Image de l'article",
	"admin_itemImageCaption" => "Légende de l'image de l'article",
	...
	"admin_js" => "JS personalisé",
	"admin_header" => "En-Tête personalisée",
	"admin_footer" => "Pied de page personalisé",
	"admin_summary" => "Sommaire",
	"admin_editCSS" => "CSS personalisé",
	"admin_editCSSSubmit" => "Modifier le CSS personalisé",
	"admin_editJS" => "JS personalisé",
	"admin_editJSSubmit" => "Modifier le JS personalisé",
	"admin_editHeader" => "En-tête personalisé",
	"admin_editHeaderSubmit" => "Modifier l'en-tête personalisée",
	"admin_editFooter" => "Pieds de page personalisé",
	"admin_editFooterSubmit" => "Modifier le pieds de page",
